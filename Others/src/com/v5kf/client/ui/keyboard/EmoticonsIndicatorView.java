...
//    private AnimatorSet mPlayByOutAnimatorSet;
    ...
    public EmoticonsIndicatorView(Context context, AttributeSet attrs) {
        ...
        bmpSelect= BitmapFactory.decodeResource(getResources(), R.drawable.v5_indicator_point_select1);
        bmpNomal= BitmapFactory.decodeResource(getResources(), R.drawable.v5_indicator_point_nomal);
    }
