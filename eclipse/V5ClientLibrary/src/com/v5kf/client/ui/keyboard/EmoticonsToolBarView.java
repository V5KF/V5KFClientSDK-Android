...
public class EmoticonsToolBarView extends RelativeLayout implements IEmoticonsKeyboard {
    ...
    public EmoticonsToolBarView(Context context, AttributeSet attrs) {
        ...
        inflater.inflate(R.layout.v5_view_emoticonstoolbar, this);
...
//                    int childX = (int)ViewHelper.getX(ly_tool.getChildAt(position));
    ...
    public void setToolBtnSelect(int select) {
        ...
        for (int i = 0; i < mToolBtnList.size(); i++) {
            if (select == i) {
                mToolBtnList.get(i).setBackgroundColor(getResources().getColor(R.color.v5_toolbar_btn_select));
            } else {
                mToolBtnList.get(i).setBackgroundColor(getResources().getColor(R.color.v5_toolbar_btn_nomal));
            }
        }
    }
    ...
    public void addData(int rec){
        if(ly_tool != null){
            ...
            View toolBtnView = inflater.inflate(R.layout.v5_item_toolbtn, null);
